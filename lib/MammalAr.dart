...
class MammalAr extends StatelessWidget {
  @override
          ...
          children: <Widget>[
            Card(
              child: ListTile(
                ...
                title: Text('Arabian Red Fox', style: GoogleFonts.courgette(textStyle:TextStyle(fontSize: 17)),textAlign: TextAlign.right,),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            Card(
              child: ListTile(
                ...
                title: Text('Black Rat', style: GoogleFonts.courgette(textStyle:TextStyle(fontSize: 17)),textAlign: TextAlign.right),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            Card(
              child: ListTile(
                ...
                title: Text('Sand Gazelle', style: GoogleFonts.courgette(textStyle:TextStyle(fontSize: 17)),textAlign: TextAlign.right),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            Card(
              child: ListTile(
                ...
                title: Text('Domestic Cat', style: GoogleFonts.courgette(textStyle:TextStyle(fontSize: 17)),textAlign: TextAlign.right),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
